        ...
        http
            ...
            .authorizeHttpRequests(auth -> 
                auth
                    ...
                    .requestMatchers("/api/v1/suplementos/**").permitAll()
                    ...
                    .requestMatchers("/api/v1/usuarios/**").hasAnyRole("USER", "ADMIN")
                    .requestMatchers("/api/v1/pedidos/**").hasAnyRole("USER", "ADMIN")
                    .requestMatchers("/api/v1/avaliacoes/**").hasAnyRole("USER", "ADMIN")
